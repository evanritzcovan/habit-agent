-- One-shot: paste into Supabase Dashboard → SQL → New query, then Run.
-- Alternative: from repo root, set SUPABASE_DB_PASSWORD in .env and run: npm run db:push
-- Do not edit this file for schema changes; edit files under supabase/migrations/ and regenerate or run db:push
...
--== 20260422120000_drop_habits_difficulty.sql ==--
